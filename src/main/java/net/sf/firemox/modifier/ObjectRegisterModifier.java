 ...
 * @since 0.85
 */
public class ObjectRegisterModifier extends RegisterModifier {

	/**
	 * Creates a new instance of IdCardModifiers <br>
	 * 
	 * @param context
	 ...
	 */
	public ObjectRegisterModifier(ModifierContext context, int index,
			Expression rightExpression, Operation op, boolean main) {
		super(context, index, rightExpression, op);
