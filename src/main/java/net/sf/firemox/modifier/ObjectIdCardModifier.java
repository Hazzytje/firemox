 ...
 * @since 0.86
 */
public class ObjectIdCardModifier extends IdCardModifier {

	/**
	 * Creates a new instance of ObjectIdCardModifier <br>
	 * 
	 * @param context
	 *          the modifier context.
	 * @param idCard
	 *          the id Card to add/remove
	 * @param op
	 ...
	 */
	public ObjectIdCardModifier(ModifierContext context, Expression idCard,
			Operation op, boolean main) {
		super(context, idCard, op);
