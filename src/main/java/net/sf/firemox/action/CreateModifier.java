 ...
 * @since 0.80
 */
class CreateModifier extends UserAction implements StandardAction {

	/**
	 * Create an instance of CreateModifier by reading a file Offset's file must
	 * pointing on the first byte of this action
	 * <ul>
	 * Structure of InputStream : Data[size]
	 * <li>modifier to add [...]</li>
	 * </ul>
	 * 
	 * @param inputFile
	 ...
	 *           input stream
	 */
	CreateModifier(InputStream inputFile) throws IOException {
		super(inputFile);
		modifier = ModifierFactory.readModifier(inputFile);
	}

	@Override
	public final Actiontype getIdAction() {
		return Actiontype.CREATE_MODIFIER;
	}
