 ...
 * @since 0.82
 */
class TargetListRemoveLast extends TargetList {

	/**
	 * Create an instance of TargetListRemoveLast by reading a file Offset's file
	 ...
	 */
	TargetListRemoveLast(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	...
	public String toString(Ability ability) {
		return "target-list.remove-last";
	}
