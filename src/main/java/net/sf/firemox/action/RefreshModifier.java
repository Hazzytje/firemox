 ...
 */
public class RefreshModifier extends MAction implements StandardAction {
	 ...
	 * @param modifier
	 */
	public RefreshModifier(Modifier modifier) {
		super();
	...
	public final Actiontype getIdAction() {
		return Actiontype.REFRESH_MODIFIER;
	}
	...
	public String toString(Ability ability) {
		return "refresh modifier : " + modifier;
	}
