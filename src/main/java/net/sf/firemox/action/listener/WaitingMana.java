 ...
 * @since 0.86
 */
public interface WaitingMana extends Waiting {

	/**
	 * Called to specify the mana component chosen for the current action by the
	 * handed player
	 * 
	 * @param mana
	 ...
	 * in the <code>clickOn(Mana)</code> function. <br>
	 * <ul>
	 * The calls chain is :
	 * <li>actionListener call clickOn(Mana)
	 * <li>if returned value is false we give hand to the player and exit, else
	 * we continue
	 * <li>actionListener call succeedClickOn(Mana)
	 * </ul>
	 * 
	 * @param mana
