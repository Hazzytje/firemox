 ...
 * @since 0.82
 */
class IntListClear extends IntList {

	/**
	 * Create an instance of IntListClear by reading a file Offset's file must
	 ...
	 */
	IntListClear(InputStream inputFile) throws IOException {
		super(inputFile);
