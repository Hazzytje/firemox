 ...
 * @since 0.82
 */
class IntListRemoveFirst extends IntList {

	/**
	 * Create an instance of IntListRemoveFirst by reading a file Offset's file
	 ...
	 */
	IntListRemoveFirst(InputStream inputFile) throws IOException {
		super(inputFile);
	...
	public boolean play(ContextEventListener context, Ability ability) {
		...
		if (listIndex < 0) {
			StackManager.intList.removeFirstInt();
		} else {
			StackManager.SAVED_INT_LISTS.get(listIndex).removeFirstInt();
		}
		return true;
	}
