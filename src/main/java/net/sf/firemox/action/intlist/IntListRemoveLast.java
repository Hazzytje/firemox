 ...
 * @since 0.82
 */
class IntListRemoveLast extends IntList {

	/**
	 * Create an instance of IntListRemoveLast by reading a file Offset's file
	 ...
	 */
	IntListRemoveLast(InputStream inputFile) throws IOException {
		super(inputFile);
