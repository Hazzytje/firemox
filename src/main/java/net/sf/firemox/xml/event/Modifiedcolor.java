 ...
 * @since 0.82
 */
public class Modifiedcolor implements XmlToMDB {

	/**
	 * <ul>
	 * Structure of stream : Data[size]
	 * <li>super [TriggeredEvent1]</li>
	 * <li>test [Test]</li>
	 ...
	 * @see net.sf.firemox.event.ModifiedIdColor
	 * @throws IOException
	 */
	public final int buildMdb(XmlParser.Node node, OutputStream out)
			throws IOException {
		// write the idEvent
		Event.MODIFIED_IDCOLOR.write(out);
		...
		// write the idToken
		XmlTools.writeAttrOptions(node, node.getAttribute("color"), out, "Color");
		return 0;
	}
