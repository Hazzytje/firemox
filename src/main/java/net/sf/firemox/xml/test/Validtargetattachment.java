 ...
 * @since 0.91
 */
public class Validtargetattachment implements XmlToMDB {
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
		...
		XmlTest.buildMdbCard(node, out, IdTest.VALID_TARGET_ATTACHMENT);
		XmlTools.writeTestOn(out, node.getAttribute("from"));
		return 0;
	}
