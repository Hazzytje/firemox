 ...
 * test may be used in the restriction test of <code>givemana</code> action.
 * 
 * @author <a href="mailto:fabdouglas@users.sourceforge.net">Fabrice Daugan </a>
 * @since 0.86
 */
public class Playableability implements XmlToMDB {
	 ...
	 * <li>idTest [1]</li>
	 * <li>playable idCard [Expression]</li>
	 * </ul>
	 * 
	 * @param node
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
			throws IOException {
		IdTest.PLAYABLE_ABILITY.serialize(out);
