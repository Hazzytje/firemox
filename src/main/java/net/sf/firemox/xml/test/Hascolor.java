 ...
 * @since 0.82
 */
public class Hascolor implements XmlToMDB {
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
			throws IOException {
		XmlTest.buildMdbCard(node, out, IdTest.HAS_COLOR);
		XmlTools.writeAttrOptions(node, "color", out, "Color");
		return 0;
	}
