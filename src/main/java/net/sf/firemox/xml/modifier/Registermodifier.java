 ...
 * @since 0.82
 */
public class Registermodifier implements XmlToMDB {
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
		...
		if (idOperation == IdOperation.CLEAR || idOperation == IdOperation.SET) {
			throw new InternalError(
					"Do not use [set; clear] operations for register modifier");
		}
