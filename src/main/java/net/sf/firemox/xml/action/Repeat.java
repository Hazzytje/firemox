 ...
 * @since 0.82
 */
public class Repeat implements XmlToMDB {
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
		...
		final String colorAttr = node.getAttribute("value");
		if ("1".equals(colorAttr)) {
			return 0;
		}

		XmlAction.buildMdb(Actiontype.REPEAT_ACTION, node, out);
