 ...
 * @since 0.82
 */
public class Sound implements XmlToMDB {
	...
	public final int buildMdb(XmlParser.Node node, OutputStream out)
			throws IOException {
		// write the type
		XmlAction.buildMdb(Actiontype.SOUND, node, out);

		// sound filename to play
		MToolKit.writeString(out, node.getAttribute("file"));
		return 1;
	}
