 ...
 * Original filename was Add.java
 * 
...
/**
 * Reprsents the PLUS operation. This operation is optimzed since it is not
 * executed is is useless.
 * 
...
public final class Add extends BinaryOperation {
	...
	/**
	 * Creates a new instance of Add <br>
	 */
	private Add() {
		super();
	}
	...
	public boolean isUselessWith(int leftValue, int rightValue) {
		return super.isUselessWith(leftValue, rightValue) || rightValue <= 0;
	}
