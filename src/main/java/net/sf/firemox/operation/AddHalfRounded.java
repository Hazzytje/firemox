 ...
 * Original filename was AddHalfRounded.java
 * 
 ...
 * @since 0.72
 */
public final class AddHalfRounded extends BinaryOperation {

	/**
	 * Creates a new instance of AddHalfRounded <br>
	 */
	private AddHalfRounded() {
		super();
	}

	@Override
	public int process(int leftValue, int rightValue) {
		return leftValue + DivRounded.getInstance().process(rightValue, 2);
	}
