 ...
 * Original filename was DivTruncated.java
 * 
 ...
 * @since 0.71
 */
public final class DivTruncated extends BinaryOperation {

	/**
	 * Creates a new instance of DivTruncated <br>
	 */
	private DivTruncated() {
		super();
	}
