 ...
 * Original filename was Decrement.java
 * 
...
/**
 * Return the given value less ONE.
 * 
 * @author <a href="mailto:fabdouglas@users.sourceforge.net">Fabrice Daugan </a>
 */
final class Decrement extends UnaryOperation {

	/**
	 * Creates a new instance of Decrement <br>
	 */
	private Decrement() {
		super();
	}
