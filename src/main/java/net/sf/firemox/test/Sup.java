 ...
 * @since 0.54
 */
@XmlTestElement(id = IdTest.SUP)
public class Sup extends TestExpr {

	/**
	 * Create an instance of Sup by reading a file. Offset's file must pointing on
	 ...
	 *           input stream
	 */
	Sup(InputStream inputFile) throws IOException {
		super(inputFile);
	}

	/**
	 * Create a new instance of Sup given left and right expression.
	 * 
	 ...
	 */
	private Sup(Expression leftExpression, Expression rightExpression) {
		super(leftExpression, rightExpression);
	}

	@Override
	public Test getConstraintTest(Map<String, Expression> values) {
		return new Sup(leftExpression.getConstraintExpression(values),
