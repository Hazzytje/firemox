 ...
 * @since 0.54
 */
@XmlTestElement(id = IdTest.INF)
public class Inf extends TestExpr {

	/**
	 * Create an instance of IsInf by reading a file. Offset's file must pointing
	 ...
	 *           input stream
	 */
	Inf(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	 ...
	 */
	private Inf(Expression leftExpression, Expression rightExpression) {
		super(leftExpression, rightExpression);
	}

	@Override
	public Test getConstraintTest(Map<String, Expression> values) {
		return new Inf(leftExpression.getConstraintExpression(values),
