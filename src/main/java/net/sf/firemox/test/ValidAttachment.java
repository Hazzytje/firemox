 ...
 * @since 0.91
 */
public class ValidAttachment extends AbstractValidAttachment {
	 ...
	 *           input stream
	 */
	ValidAttachment(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	...
	public boolean test(Ability ability, Target tested) {
		...
		return attachment != null
				&& attachment.getValidAttachment().test(
						getFromCardAbility(ability, from),
