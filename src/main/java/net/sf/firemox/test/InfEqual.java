 ...
 * @since 0.54
 */
@XmlTestElement(id = IdTest.INF_EQUAL)
public class InfEqual extends TestExpr {

	/**
	 * Create an instance of InfEqual by reading a file. Offset's file must
	 ...
	 *           input stream
	 */
	InfEqual(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	 ...
	 */
	private InfEqual(Expression leftExpression, Expression rightExpression) {
		super(leftExpression, rightExpression);
	}

	@Override
	public Test getConstraintTest(Map<String, Expression> values) {
		return new InfEqual(leftExpression.getConstraintExpression(values),
