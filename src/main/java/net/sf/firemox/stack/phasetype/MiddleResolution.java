 ...
 * Original filename was MiddleResolution.java
 * 
 ...
 * @since 0.60
 */
public class MiddleResolution extends StackCondition {
	 ...
	 * @throws IOException
	 */
	MiddleResolution(InputStream inputStream) throws IOException {
		super(inputStream);
	}
