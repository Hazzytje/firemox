 ...
 * @since 0.86
 */
public class ToCode extends Expression {

	/**
	 * Creates a new instance of ToCode <br>
	 * <ul>
	 ...
	 *           input stream
	 */
	public ToCode(InputStream inputFile) throws IOException {
		super();
	...
	public int getValue(Ability ability, Target tested,
		...
		return 1 << (expr.getValue(ability, tested, context) - 1);
	}
