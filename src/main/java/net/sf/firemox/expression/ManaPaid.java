 ...
 * @since 0.93
 */
public class ManaPaid extends Expression {

	/**
	 * Creates a new instance of ManaPaid <br>
	 * <ul>
	 ...
	 *           input stream
	 */
	public ManaPaid(InputStream inputFile) throws IOException {
		super();
	...
	public int getValue(Ability ability, Target tested,
		...
		return StackManager.getManaPaid(on.getCard(ability, tested), color
				.getValue(ability, tested, context));
	}
