 ...
 */
public class Last extends SavedListExpression {

	/**
	 * Creates a new instance of First <br>
	 * <ul>
	 ...
	 *           input stream
	 */
	public Last(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	...
	public int getValue(Ability ability, Target tested,
		...
		return getIntList(ability, tested, context).getLastInt();
	}
}
