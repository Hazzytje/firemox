 ...
 */
public class IndexOf extends SavedListExpression {

	/**
	 * Creates a new instance of IndexOf <br>
	 * <ul>
	 ...
	 *           input stream
	 */
	public IndexOf(InputStream inputFile) throws IOException {
		super(inputFile);
	...
	public int getValue(Ability ability, Target tested,
		...
		return getIntList(ability, tested, context).indexOf(value);
	}
