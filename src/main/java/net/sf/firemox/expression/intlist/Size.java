 ...
 */
public class Size extends SavedListExpression {

	/**
	 * Creates a new instance of Size <br>
	 * <ul>
	 ...
	 *           input stream
	 */
	public Size(InputStream inputFile) throws IOException {
		super(inputFile);
	}
	...
	public int getValue(Ability ability, Target tested,
		...
		return getIntList(ability, tested, context).size();
	}
}
